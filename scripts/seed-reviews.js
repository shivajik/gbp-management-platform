...
async function seedReviews() {
  try {
    ...
    if (!businessProfile) {
      console.log(
        '❌ No business profiles found. Please run the main seed script first.'
      );
      return;
    }

    console.log(
      `📍 Using business profile: ${businessProfile.name} (${businessProfile.id})\n`
    );
    ...
    if (existingReviews > 0) {
      console.log(
        `⚠️  Found ${existingReviews} existing reviews. Skipping creation.`
      );
      console.log(
        'To reset, delete existing reviews first or use a different business profile.'
      );
      return;
    }
    ...
    const reviewsData = [
      {
        ...
        rating: 5,
        content:
          "Outstanding service! The team was professional, punctual, and exceeded my expectations. I couldn't be happier with the results. Definitely recommending to all my friends and family!",
      ...
      },
      {
        ...
        rating: 4,
        content:
          'Really good experience overall. The quality was solid and pricing was fair. Minor delay in communication but nothing that impacted the final outcome. Would use again.',
      ...
      },
      {
        ...
        rating: 2,
        content:
          'Had some issues with the service. Communication could be better and there were unexpected delays. The final result was okay but not what I was hoping for.',
      ...
      },
      {
        ...
        rating: 5,
        content:
          'Absolutely fantastic! From start to finish, everything was handled with care and precision. The attention to detail was impressive. This is how customer service should be done!',
      ...
      },
      {
        ...
        rating: 3,
        content:
          'Average experience. Nothing particularly stood out, but nothing terrible either. The service was adequate and met basic expectations.',
      ...
      },
      {
        ...
        rating: 1,
        content:
          'Very disappointed with the entire experience. Poor communication, delays, and the final result was not as promised. Would not recommend.',
      ...
      },
      {
        ...
        rating: 4,
        content:
          'Good value for money and professional service. The team was knowledgeable and helpful throughout the process. Minor room for improvement but overall satisfied.',
      ...
      },
      {
        ...
        rating: 5,
        content:
          'Exceptional! They went above and beyond what was expected. Professional, friendly, and delivered exactly what they promised. Highly recommend!',
    ...
    for (const reviewData of reviewsData) {
      ...
      console.log(
        `✅ ${review.reviewerName}: ${review.rating}⭐ (${review.sentiment})`
      );
    }
    ...
    const respondedReviews = createdReviews.filter(
        ...
        await prisma.reviewResponse.create({
          data: {
            ...
            publishedAt: new Date(
              review.publishedAt.getTime() + 24 * 60 * 60 * 1000
            ), // 1 day after review
